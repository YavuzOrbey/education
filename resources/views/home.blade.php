...
@section('content')
                    ...
                    <p>Each assignment will have an associated pdf. Just click the name or the pdf icon to download it. When you’re ready input your answers and you should have instant feedback. No more waiting for graded papers!</p>
                    </div>
@endsection
